...
public class GPSLocationAndroid : MonoBehaviour
{
    ...
    IEnumerator GetLocation()
    {
        ...
        else
        {
            ...
            gpsOut.text = "Location: " + latitude + " " + longitude + " " + Input.location.lastData.altitude + 100f + " " + Input.location.lastData.horizontalAccuracy + " " + Input.location.lastData.timestamp;
